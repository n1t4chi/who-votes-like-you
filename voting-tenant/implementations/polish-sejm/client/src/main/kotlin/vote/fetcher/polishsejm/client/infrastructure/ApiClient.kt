...
open class ApiClient(val baseUrl: String, val client: Call.Factory = defaultClient) {
    companion object {
        ...
        const val BASE_URL_KEY: String = "vote.fetcher.polishsejm.client.baseUrl"
     ...
     */
    protected fun buildPartHeaders(
        name: String,
     ...
     */
    protected fun serializePartBody(
        obj: Any?,
        contentType: String?,
            ...
            mediaType == TEXT_MEDIA_TYPE -> {
                val textualContent = when (content) {
                    ...
                    is Boolean -> content.toString()
                        ...
                        "requestBody currently only supports text body containing primitive types: characters, numbers, or booleans.",
                    )
                }
    ...
    protected inline fun <reified T : Any?> responseBody(
        ...
        if (T::class.java == Unit::class.java) {
            ...
            val tempFile = java.nio.file.Files
